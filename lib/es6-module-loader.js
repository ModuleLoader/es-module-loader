...
(function () {
  ...
  (function() {
    ...
    var ES6Parser = {
      ...
      loadTraceur: function(name, source, callback, errback) {
        ...
        global.System.load(traceurSrc, function() {
          ...
          self.createModuleLoaderTransformer(
            global.System.get('../src/syntax/trees/ParseTrees'),
            global.System.get('../src/codegeneration/ParseTreeFactory'), 
            global.System.get('../src/codegeneration/ParseTreeTransformer').ParseTreeTransformer
          );
      ...
      createModuleLoaderTransformer: function(ParseTrees, ParseTreeFactory, ParseTreeTransformer) {
        ...
        ModuleTransformer.prototype.transformExportDeclaration = function(tree) {
          ...
          // export var p = 4;
            ...
            var initializer = this.transformAny(varDeclaration.initializer);
            varDeclaration.initializer = createAssignmentExpression(createExportExpression(exportName), initializer);
          ...
          // export function q() {}
            ...
            var varDeclaration = createVariableDeclaration(
              ...
              createAssignmentStatement(createExportExpression(exportName), this.transformAny(declaration))
            );
          ...
          // export default ...
            ...
            return createAssignmentExpression(createExportExpression('default'), this.transformAny(declaration.expression));
          }
      ...
      parseEval: function(source, loader, opt) {
        ...
        source = this.traceur.outputgeneration.TreeWriter.write(tree, {});
        if (isBrowser)
    ...
    if (!isBrowser)
      ES6Parser.traceur = require('traceur');
