    ...
    */
    ...
    Loader.prototype = {
      define: function(name, source, options) {
        ...
        importPromises[name] = Promise(asyncStartLoadPartwayThrough(this, name, options && options.address ? 'fetch' : 'translate', options && options.meta || {}, options && options.address, source));
    ...
    */
    ...
    var System = new Loader({
      ...
      instantiate: function(load) {
        ...
        if (load.metadata.format != 'es6' && load.name && !load.source.match(es6RegEx))
          return {
            deps: [],
            execute: function() {
