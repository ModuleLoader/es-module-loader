    ...
    */
    ...
    Loader.prototype = {
      define: function(name, source, options) {
        ...
        importPromises[name] = Promise(asyncStartLoadPartwayThrough(this, name, options.address ? 'fetch' : 'translate', options && options.meta || {}, options && options.address, source));
