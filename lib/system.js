...
(function (global) {
  ...
  (function() {
    ...
    RemappingLoader.prototype = Object.create(Loader.prototype);

    RemappingLoader.prototype.normalize = function(name, parentName, parentAddress) {
    ...
    RemappingLoader.prototype.locate = function(load) {
      var name = load.name;
    ...
    RemappingLoader.prototype.fetch = function(load) {
    ...
    RemappingLoader.prototype.parse = function(load) {
      if (!traceur) {
    ...
    if (isBrowser) {
      ...
      System = new RemappingLoader({}, href.substring(0, href.lastIndexOf('/') + 1));
    }
    else {
      System = new RemappingLoader({}, process.cwd() + '/');
    }
