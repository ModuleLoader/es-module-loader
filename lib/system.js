...
(function (global) {
  ...
  (function() {
    ...
    function RemappingLoader(options, baseURL, paths) {
      // The methods on this class become the default hooks.
      Loader.call(this, RemappingLoader.prototype);
      // The option hooks override the methods.
      Loader.prototype._setHooks.call(this, options);
      if (options.parse)
    ...
    RemappingLoader.prototype = {
      __proto__: Loader.prototype,
    ...
    function TraceurRemappingLoader(options, baseURL, paths) {
      options.parse = TraceurRemappingLoader.prototype.parse;
      RemappingLoader.call(this, options, baseURL, paths);
    }

    // parse function is used to parse a load record
    // Returns an array of ModuleSpecifiers
    TraceurRemappingLoader.prototype = {
      __proto__: RemappingLoader.prototype,
      parse: function(load) {
        if (!traceur) {
    ...
    if (isBrowser) {
      ...
      System = new TraceurRemappingLoader({}, href.substring(0, href.lastIndexOf('/') + 1));
    }
    else {
      System = new TraceurRemappingLoader({}, process.cwd() + '/');
    }
    ...
    // Provide access to our extended Loader classes.
    System.RemappingLoader = RemappingLoader;
    System.TraceurRemappingLoader = TraceurRemappingLoader;
