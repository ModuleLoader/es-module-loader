...
describe('System', function () {
  ...
  describe('prerequisite', function () {
    ...
    it('should be a instance of Loader', function () {
      expect(System.loader).to.be.a(Reflect.Loader);
    });
  ...
  describe('#import', function () {
    ...
    describe('an ES5 script', function () {
      ...
      it('should import a ES5 script', function (done) {
        System.loader.import(base + 'test/syntax/script.js')
        .then(function (m) {
          expect(!!m).to.be.ok();
        })
        .then(done, done);
      ...
      it('should import a ES5 script once loaded', function (done) {
        System.loader.import(base + 'test/syntax/script.js')
        .then(function () {
          return System.loader.import(base + 'test/syntax/script.js').
            then(function (m) {
              expect(!!m).to.be.ok();
            });
        })
    ...
    describe('an ES6 script', function () {
      ...
      it('should import an ES6 script', function (done) {
        System.loader.import(base + 'test/syntax/es6.js')
        .then(function (m) {
      ...
      it('should import an ES6 script with its dependencies', function (done) {
        System.loader.import(base + 'test/syntax/es6-withdep.js')
        .then(function (m) {
          expect(m.p).to.equal('p');
        })
        .then(done, done);
      ...
      (ie ? it.skip : it)('should import an ES6 script with a generator', function (done) {
        System.loader.import(base + 'test/syntax/es6-generator.js')
        .then(function (m) {
      ...
      it('should import without bindings', function (done) {
        System.loader.import(base + 'test/syntax/direct.js')
        .then(function (m) {
          expect(!!m).to.be.ok();
        })
        .then(done, done);
      ...
      it('should support es6 various syntax', function (done) {
        System.loader.import(base + 'test/syntax/es6-file.js')
        .then(function (m) {
    ...
    describe('with circular dependencies', function () {
      ...
      (System.transpiler == 'traceur' ? it : it.skip)('should resolve circular dependencies', function (done) {
        System.loader.import(base + 'test/syntax/circular1.js')
        .then(function (m1) {
          return System.loader.import(base + 'test/syntax/circular2.js').then(function (m2) {
      ...
      it('should update circular dependencies', function (done) {
        System.loader.import(base + 'test/syntax/even.js')
        .then(function (m) {
    ...
    describe('loading order', function () {
      ...
      function expectedOrder(file, order, done) {
        System.loader.import(base + 'test/loads/' + file)
        .then(function (m) {
    ...
    describe('errors', function () {
      ...
      it('should throw if on syntax error', function (done) {
        System.loader.import(base + 'test/loads/main.js')
        .then(supposedToFail)
        .catch(function(e) {
          expect(e)
      ...
      it('should throw what the script throws', function (done) {
        System.loader.import(base + 'test/loads/deperror.js')
        .then(supposedToFail)
        .catch(function(e) {
          expect(e)
            .to.be.equal('dep error\n\tError evaluating ' + base + 'test/loads/deperror.js');
      ...
      it('404 error', function (done) {
        System.loader.import(base + 'test/loads/load-non-existent.js')
        .then(supposedToFail)
        .catch(function (e) {
    ...
    describe('es6 export syntax overview', function () {
      it('should resolve different export syntax', function (done) {
        System.loader.import(base + 'test/syntax/export.js')
        .then(function (m) {
    ...
    describe('es6 export default syntax', function () {
      it('should resolve "export default"', function (done) {
        System.loader.import(base + 'test/syntax/export-default.js')
        .then(function (m) {
    ...
    describe('es6 export re-exporting', function () {
      it('should support simple re-exporting', function (done) {
        System.loader.import(base + 'test/syntax/reexport1.js')
        .then(function (m) {
      ...
      it('should support re-exporting binding', function (done) {
        System.loader.import(base + 'test/syntax/reexport-binding.js')
        .then(function () {
          return System.loader.import(base + 'test/syntax/rebinding.js').then(function (m) {
      ...
      it('should support re-exporting with a new name', function (done) {
        System.loader.import(base + 'test/syntax/reexport2.js')
        .then(function (m) {
      ...
      it('should support re-exporting', function (done) {
        System.loader.import(base + 'test/syntax/export-star.js')
        .then(function (m) {
      ...
      (System.transpiler != 'traceur' ? it.skip : it)('should support re-exporting overwriting', function (done) {
        System.loader.import(base + 'test/syntax/export-star2.js')
        .then(function (m) {
          expect(m.bar, 'should re-export "./export-star" bar variable')
            .to.be.equal('bar');
    ...
    describe('es6 import syntax overview', function () {
      it('should resolve different import syntax', function (done) {
        System.loader.import(base + 'test/syntax/import.js')
        .then(function (m) {
    ...
    describe('a script with metas', function () {
      ...
      it.skip('should support module name meta', function (done) {
        System.loader.import(base + 'test/loader/moduleName.js')
        .then(function (m) {
  ...
  describe('#System.loader.provide', function () {

    it('System.loader.provide source', function(done) {
      var oldResolve = System.loader.hook('resolve');
      System.loader.hook('resolve', function(url) {
        if (url == 'slave') {
          return new Promise(function(resolve, reject) {
            System.loader.provide('slave', 'fetch', 'export var p = 5;');
            setTimeout(function() {
              resolve('slave');
            }, 1);
          });
      ...
      System.loader.import(base + 'test/loader/master.js').then(function(m) {
        expect(m.p).to.be.equal(5);
      }).then(reset, reset);

      function reset() {
        done.apply(this, arguments);
        System.loader.hook('resolve', oldResolve);
      }
    });
